...
PROVIDES += " virtual/kodi-aml "
RPROVIDES_${PN} += "virtual/kodi-aml"
PROVIDES += "kodi-aml"
RPROVIDES_${PN} += "kodi-aml"
...
DEPENDS = " \
            ...
            alsa-lib \
            alsa-plugins \
 libamadec libamcodec libamavutils \
          "

SRCREV = "816d15e57b25e96fb0da5300dd9272f591f13046"
...
SRC_URI = "git://github.com/xbmc/xbmc.git;branch=Krypton \
           ...
           file://0011-Let-configure-pass-on-unknown-architectures-setting-.patch \
            \
          file://e2stb-settings.patch \
          file://905-platform.patch \
          file://ffmpeg-autobuild.patch \
           \
           file://g12-Force_setting_level_to_expert.patch \
           file://info.patch \
           file://kodi \
"
...
# --target=${TARGET_SYS}  cpu==target 
# --arch=aarch64 - bad probably aarch64-oe-linux
...
### Custom kodi shell if run with uSDextra
#do_install_append() {
#   install -d ${D}/usr/bin/
#   install -m 755 ${WORKDIR}/kodi ${D}/usr/bin/
#}
